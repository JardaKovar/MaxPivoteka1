...
try {
    ...
    $rentalItems = [
        ...
        [3, 'BOMBA', 'bomba.png', 'PIVNÍ BOMBA', '1500', '150', '300', '800', '2000'],
        [4, 'NUTCASE', 'pivset (2).png', 'PIVNÍ SET', '1000', '100', '200', '500', '1200'],
        [5, 'PEPÍK', '', 'SPECIÁLNÍ VYBAVENÍ', '500', '50', '100', '250', '600']
    ];
    ...
    echo "All 5 rental items are now available in both database and JSON fallback.\n";
