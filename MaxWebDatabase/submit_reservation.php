...
if (empty($rental_period)) {
    $errors[] = 'Výběr období půjčení je povinný';
}
...
try {
    ...
    $stmt = $pdo->prepare("INSERT INTO reservations (first_name, last_name, email, phone, rental_item, rental_period, rental_date_from, rental_date_to, additional_info, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending')");
    $stmt->execute([$first_name, $last_name, $email, $phone, $rental_item, $rental_period, $rental_date_from, $rental_date_to, $additional_info]);
    ...
    <body>
        ...
        <div class='content'>
            ...
            <div class='details'>
                ...
                <p><strong>Období půjčení:</strong> " . htmlspecialchars($rental_period) . "</p>
